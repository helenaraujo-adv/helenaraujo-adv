# Olá, eu sou Helen Araújo 👋 ⚖️

### Advogada | Especialista em Direito Digital | Founder & CLO

Sou uma profissional com mais de 15 anos de carreira, unindo a segurança do Direito à disrupção da tecnologia. Minha missão é traduzir a complexidade jurídica para o ecossistema de inovação, garantindo compliance e escalabilidade para startups.
...
- **Law & AI:** Governança de IA, ética de dados e automação de processos jurídicos.
- **Direito Digital:** LGPD, Propriedade Intelectual em software e Contratos de Tecnologia.
- **Inovação Produtiva:** Uso da Lei da Aprendizagem como ferramenta de inclusão social e tecnológica.
- **Logística Fluvial:** Estruturação jurídica para monitoramento de dados em áreas remotas.

## 🏆 Reconhecimentos

- **Prêmio Sebrae Mulher de Negócios 2025** (Ciência e Tecnologia - AM).
- **Menção Honrosa da Câmara Municipal de Manaus** (Destaque Jurídico 2025).
- Projeto aprovado no **Programa Centelha II/AM**.
